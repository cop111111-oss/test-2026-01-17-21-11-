...
const App: React.FC = () => {
  ...
  const SectionHeader = ({ title, subtitle }: { title: string; subtitle?: string }) => (
    <div className="mb-20 text-center">
      <h2 className="text-4xl md:text-6xl font-black mb-6 tracking-tighter uppercase text-white drop-shadow-lg">{title}</h2>
      {subtitle && <p className="text-blue-100/60 max-w-2xl mx-auto text-lg leading-relaxed font-medium">{subtitle}</p>}
      ...
      <section className="relative h-screen flex items-center overflow-hidden bg-transparent">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-blue-100/70 mb-12 leading-relaxed max-w-2xl font-medium">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <button 
                ...
                className="px-10 py-5 bg-white/10 backdrop-blur-xl border border-white/20 hover:bg-white/20 text-white font-black rounded-full transition-all duration-300"
              >
                상담 신청
              </button>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            ...
            <div key={i} className="group p-10 bg-white/[0.04] backdrop-blur-3xl border border-white/10 rounded-[3rem] hover:border-emerald-500/50 transition-all duration-500 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
              ...
              <p className="text-blue-100/50 text-sm leading-relaxed font-medium">{stat.desc}</p>
            </div>
          ))}
        </div>
      </section>
            ...
            {content.services.map((service, i) => (
              <div key={service.id} className="group cursor-pointer">
                <div className="relative overflow-hidden rounded-[3rem] mb-8 aspect-[4/5] border border-white/10 shadow-2xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-blue-950/90 via-transparent to-transparent group-hover:from-blue-900/80 transition-all duration-500"></div>
                ...
                <p className="text-blue-100/40 leading-relaxed text-sm mb-6 line-clamp-2 px-2 font-medium">{service.description}</p>
                <div className="h-[1px] w-full bg-white/10 mb-6 group-hover:bg-emerald-500/50 transition-all duration-500"></div>
                <button onClick={() => setCurrentPage('services')} className="flex items-center space-x-2 text-white/30 group-hover:text-emerald-400 font-black text-xs uppercase tracking-widest transition-all duration-300 ml-2">
    ...
    <div className="max-w-7xl mx-auto px-4 py-32 space-y-32">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
        <div className="relative">
          ...
          <p className="text-xl text-blue-100/60 leading-relaxed mb-12 font-medium">{content.aboutDescription}</p>
          <div className="grid grid-cols-2 gap-8 mb-12">
             <div className="p-8 bg-white/[0.05] backdrop-blur-3xl rounded-3xl border border-white/10 shadow-xl">
               ...
               <div className="text-[10px] text-blue-100/40 font-black uppercase tracking-widest">Client Satisfaction</div>
             </div>
             <div className="p-8 bg-white/[0.05] backdrop-blur-3xl rounded-3xl border border-white/10 shadow-xl">
               <div className="text-purple-400 font-black text-4xl mb-1">15+</div>
               <div className="text-[10px] text-blue-100/40 font-black uppercase tracking-widest">Years Expertise</div>
             </div>
          </div>
          <div className="relative p-10 bg-emerald-500/5 backdrop-blur-3xl rounded-[3rem] border border-emerald-500/30 shadow-2xl">
        ...
        {content.services.map((service, index) => (
          <div key={service.id} className={`flex flex-col ${index % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-24 items-center group`}>
            <div className="flex-1">
              ...
              <p className="text-xl text-blue-100/50 leading-relaxed mb-12 font-medium">{service.description}</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
                {["에너지 효율 정밀 분석", "정부 보조금 혜택 가이드", "고성능 단열 시스템", "탄소 배출권 컨설팅"].map((item, i) => (
                  <div key={i} className="flex items-center space-x-3 text-sm font-bold text-blue-100/70 bg-white/[0.04] py-5 px-6 rounded-2xl border border-white/5 shadow-md">
                    <div className="w-2.5 h-2.5 bg-emerald-400 rounded-full shadow-[0_0_12px_rgba(52,211,153,0.8)]"></div>
                    <span>{item}</span>
                  </div>
                ))}
              </div>
              <button onClick={() => setCurrentPage('contact')} className="px-12 py-5 bg-emerald-500 text-white hover:bg-emerald-400 transition-all duration-500 rounded-full font-black uppercase tracking-widest text-xs shadow-[0_10px_30px_rgba(16,185,129,0.3)]">
                Inquiry Now
              </button>
            </div>
    ...
    <div className="max-w-7xl mx-auto px-4 py-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {content.portfolio.map((item) => (
          <div key={item.id} className="group bg-white/[0.04] backdrop-blur-3xl border border-white/10 rounded-[3rem] overflow-hidden hover:border-emerald-400/50 hover:translate-y-[-12px] transition-all duration-500 shadow-2xl">
            ...
            <div className="p-10">
              ...
              <p className="text-blue-100/40 text-sm mb-8 leading-relaxed line-clamp-2 font-medium">{item.description}</p>
              <div className="pt-8 border-t border-white/10 flex justify-between items-center">
                <span className="text-[10px] text-blue-100/20 font-black tracking-[0.3em] uppercase">Success Delivered</span>
                <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center group-hover:bg-emerald-500 group-hover:border-emerald-500 transition-all duration-300 shadow-lg">
                  <ArrowRight size={18} className="text-blue-100/30 group-hover:text-white" />
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="max-w-7xl mx-auto px-4 py-32">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 mt-20">
        <div className="lg:col-span-2 space-y-12">
          <div className="p-12 bg-white/[0.05] backdrop-blur-3xl rounded-[3.5rem] border border-white/10 relative overflow-hidden group shadow-2xl">
             ...
             <div className="space-y-10">
               <div className="flex items-center space-x-8">
                 ...
                 <div>
                   <div className="text-[10px] text-blue-100/30 font-black uppercase tracking-widest mb-1">Phone</div>
               ...
               <div className="flex items-center space-x-8">
                 ...
                 <div>
                   <div className="text-[10px] text-blue-100/30 font-black uppercase tracking-widest mb-1">Email</div>
               ...
               <div className="flex items-center space-x-8">
                 ...
                 <div>
                   <div className="text-[10px] text-blue-100/30 font-black uppercase tracking-widest mb-1">Address</div>
        ...
        <div className="lg:col-span-3">
          <div className="bg-white/[0.06] backdrop-blur-3xl p-14 rounded-[3.5rem] border border-white/20 shadow-[0_40px_100px_rgba(0,0,0,0.4)] relative">
            <form className="space-y-8" onSubmit={handleFormSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <label className="text-[13px] font-bold text-blue-100/60 ml-2 uppercase tracking-widest">이름</label>
                ...
                <div className="space-y-4">
                  <label className="text-[13px] font-bold text-blue-100/60 ml-2 uppercase tracking-widest">연락처</label>
              ...
              <div className="space-y-4">
                <label className="text-[13px] font-bold text-blue-100/60 ml-2 uppercase tracking-widest">이메일</label>
              ...
              <div className="space-y-4">
                <label className="text-[13px] font-bold text-blue-100/60 ml-2 uppercase tracking-widest">프로젝트 내용</label>
